...
public class CommonmarkRweaveSubmitContentHandler extends RweaveSubmitContentHandler {
	
	
	public CommonmarkRweaveSubmitContentHandler() {
		super(new CommonmarkRweaveDocumentSetupParticipant(), WikidocRweaveDocumentContentInfo.INSTANCE);
	}
