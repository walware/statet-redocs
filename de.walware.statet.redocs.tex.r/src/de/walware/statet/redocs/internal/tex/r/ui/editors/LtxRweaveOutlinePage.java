...
import de.walware.statet.redocs.internal.tex.r.ui.sourceediting.DocROutlineContentProvider;
import de.walware.statet.redocs.r.ui.RedocsRUIResources;
import de.walware.statet.redocs.tex.r.ui.TexRweaveLabelProvider;
...
public class LtxRweaveOutlinePage extends SourceEditor2OutlinePage {
	...
	private class FilterRChunks extends AbstractToggleHandler {
		...
		protected void apply(final boolean on) {
			...
			LtxRweaveOutlinePage.this.fFilter.hideRChunks= on;
	...
	public class ExpandElementsContributionItem extends HandlerContributionItem {
		...
		public ExpandElementsContributionItem(
			...
			this.fExpandElementsHandler= handlers.get(EXPAND_ELEMENTS_COMMAND_ID);
		}
		...
		protected void initDropDownMenu(final MenuManager menuManager) {
			menuManager.addMenuListener(new IMenuListener2() {
				...
				public void menuAboutToShow(final IMenuManager manager) {
					...
					if (modelInfo.getMinSectionLevel() > 0) {
						if (modelInfo.getMinSectionLevel() < TexCommand.CHAPTER_LEVEL
							...
							manager.add(new HandlerContributionItem(new CommandContributionItemParameter(
									...
									ExpandElementsContributionItem.this.fExpandElementsHandler ));
						}
					...
					if (!LtxRweaveOutlinePage.this.fFilter.hideRChunks) {
						manager.add(new HandlerContributionItem(new CommandContributionItemParameter(
	...
	public LtxRweaveOutlinePage(final SourceEditor1 editor) {
		super(editor, TexModel.LTX_TYPE_ID, LtxRweaveRefactoringFactory.getInstance(),
	...
	protected IDialogSettings getDialogSettings() {
		return DialogUtil.getDialogSettings(RedocsTexRPlugin.getInstance(), "SweaveOutlineView"); //$NON-NLS-1$
	}
